/**
 * Agent Base Class - MODE Framework v2.0
 *
...
export interface SkillContext {
  ...
  boardHashtag?: string;
  timestamp: number;
  userPatterns?: import('@/types').UserPatterns;
...
export interface NudgeParams {
  title: string;
  body: string;
  options: import('@/types').NudgeOption[];
  priority?: import('@/types').NudgePriority;
  deliveryChannel?: import('@/types').NudgeDeliveryChannel;
  showAt?: number;
  expiresIn?: number;
}
