...
/marketing-copy --from-brief="path/to/brief.md"      # Generate from feature brief
/marketing-copy --changelog --version=1.2.0          # Generate changelog copy
```

### From Feature Brief

When using `--from-brief`, the skill reads a feature brief generated by `/feature-launcher` and generates copy for all channels using the brief's pre-computed messaging hooks and pain points.

```
/marketing-copy --from-brief="marketing/product/briefs/generated/2026-01-10-real-time-sync.md"
```

This generates:
- App Store "What's New" section
- Social media posts for all platforms
- Feature announcement email
- Landing page copy snippet

The brief provides:
- Pre-mapped pillar alignment
- ICP pain points addressed
